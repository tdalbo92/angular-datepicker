(function (global, factory) {'use strict';var fnc;fnc = (typeof exports === 'object' && typeof module !== 'undefined') ? module.exports = factory(require('angular'), require('moment')) :factory(global.angular, global.moment);}(this, function (angular, moment) {
...
Module.constant('dateTimeConfig', {
  template: function (attrs, id) {
    return '' +
      ...
      (attrs.noIncremental ? 'no-incremental="' + attrs.noIncremental + '" ' : '') +
